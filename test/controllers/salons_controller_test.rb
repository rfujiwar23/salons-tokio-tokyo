...
class SalonsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create salon" do
    assert_difference('Salon.count') do
      post salons_url, params: { salon: { address: @salon.address, comment: @salon.comment, design: @salon.design, ie: @salon.ie, name: @salon.name, phone: @salon.phone, straight: @salon.straight, tokio: @salon.tokio } }
    end
  ...
  test "should update salon" do
    patch salon_url(@salon), params: { salon: { address: @salon.address, comment: @salon.comment, design: @salon.design, ie: @salon.ie, name: @salon.name, phone: @salon.phone, straight: @salon.straight, tokio: @salon.tokio } }
